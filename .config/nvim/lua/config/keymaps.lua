...
-- Delete without copying to the system clipboard (using the black hole register)
-- map({ "n", "v" }, "d", '"_d', { desc = "Delete without yanking" })
-- map({ "n", "v" }, "dd", '"_dd', { desc = "Delete line without yanking" })

-- Delete a single character (x) without copying to the system clipboard
-- map({ "n", "v" }, "x", '"_x', { desc = "Delete character without yanking" })

-- Change text (c) without copying to the system clipboard
-- This is very useful when you want to replace a word with something you already copied
-- map({ "n", "v" }, "c", '"_c', { desc = "Change without yanking" })

-- Paste over selected text without replacing the clipboard with the deleted text
-- map("v", "p", '"_dP', { desc = "Paste over without losing current clipboard" })
